...
export function buildSystemPrompt(options: {
  ...
  return [
    ...
    "Se a mensagem da localização trouxer [Bairro identificado pela localização: ...], use esse bairro para calcular a taxa e NÃO pergunte o bairro novamente. Apenas confirme ao cliente o bairro identificado junto com a taxa.",
    "Se o cliente mandar uma localização sem bairro identificado, agradeça e só então pergunte o bairro para calcular a taxa. Não peça a localização de novo.",
