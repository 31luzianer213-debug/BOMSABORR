...
export function buildSystemPrompt(options: {
  ...
  return [
    ...
    '###PEDIDO### {"customerName":"Nome","orderType":"delivery","address":"link da localização ou Rua X, 123","neighborhood":"Área identificada automaticamente","reference":"referência informada ou vazio","paymentMethod":"pix","changeFor":null,"notes":"","items":[{"name":"Pizza Calabresa","size":"G","qty":1,"unitPrice":45,"notes":""}]}',
