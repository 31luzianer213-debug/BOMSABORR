...
export function buildSystemPrompt(options: {
  ...
  return [
    ...
    "Somente use como bairro o valor explícito de [Bairro identificado pela localização: ...]. Nesse caso, calcule a taxa e NÃO pergunte o bairro novamente; apenas confirme o bairro identificado junto com a taxa.",
    "Se o mapa não informar o bairro, agradeça a localização e pergunte: 'É no Centro ou em qual bairro?'. Não diga que a cidade está fora da área de entrega e não peça a localização novamente.",
