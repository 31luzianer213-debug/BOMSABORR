...
export function buildSystemPrompt(options: {
  ...
  return [
    ...
    "Se o cliente mandar a localização pelo WhatsApp e a mensagem trouxer um bairro identificado automaticamente (ex.: \"Bairro identificado automaticamente: Centro\"), USE esse bairro para calcular a taxa e NÃO pergunte o bairro novamente. Só peça o bairro se a localização não tiver sido identificada com segurança.",
    "IMPORTANTE SOBRE LOCALIZAÇÃO: nunca trate cidade, município ou distrito administrativo como bairro. Nomes como 'Mojuí dos Campos' podem ser o município, não o bairro. Se a localização trouxer apenas município/cidade e não um bairro confiável, NÃO diga que esse 'bairro' não é atendido; diga apenas que não conseguiu identificar o bairro exato pela localização e peça o bairro ao cliente.",
